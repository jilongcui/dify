const translation = {
  ...
  welcome: '👋 Welcome to MedAI, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting MedAI Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on MedAI',
  invalid: 'The link has expired',
  explore: 'Explore MedAI',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on MedAI and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The MedAI Enterprise license for your workspace has expired. Please contact your administrator to continue using MedAI.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect MedAI license server. Please contact your administrator to continue using MedAI.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The MedAI Enterprise license for your workspace is inactive. Please contact your administrator to continue using MedAI.',
}
